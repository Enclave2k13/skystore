...
from .mixins import BootstrapFormStylesMixin
...
class ProductForm(BootstrapFormStylesMixin, forms.ModelForm):
    class Meta:
        model = Product
        fields = ['name', 'description', 'image', 'category', 'price']
        widgets = {
            'name': forms.TextInput(attrs={'placeholder': 'Название товара'}),
            'description': forms.Textarea(attrs={'placeholder': 'Описание', 'rows': 5}),
